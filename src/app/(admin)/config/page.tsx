        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-6">
            <div className="p-8 rounded-[2rem] border border-white/10 bg-white/5">
              <h2 className="font-black uppercase text-xs mb-4 flex items-center gap-2 text-white"><Target size={16}/> WhatsApp Master</h2>
          ...
          <div className="lg:col-span-2 text-white">
            <div className="p-8 rounded-[2rem] border border-white/10 bg-white/5">
              <h2 className="font-black uppercase text-xs mb-6 flex items-center gap-2 text-white"><MessageSquare size={16}/> Filtros do Bot</h2>
              <div className="space-y-4 text-white">
                ...
                <button className="w-full bg-cyan-500 text-black py-4 rounded-xl font-black uppercase text-xs flex items-center justify-center gap-2 hover:scale-105 transition-all"><Save size={16}/> Salvar Configurações Master</button>
              </div>
            </div>
          </div>
        </div>
