        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-6">
            <div className="p-8 rounded-[2rem] border border-white/10 bg-white/5">
              ...
              <input value={numMaster} onChange={(e)=>setNumMaster(e.target.value)} placeholder="5511999999999" className="w-full bg-black/50 border border-white/10 p-4 rounded-xl text-xs text-white mb-4" />
              <button className="w-full bg-white/10 py-4 rounded-xl text-[10px] font-black uppercase hover:bg-cyan-500 transition-all flex items-center justify-center gap-2"><QrCode size={14}/> Conectar Bot</button>
            </div>
          </div>
          <div className="lg:col-span-2">
            <div className="p-8 rounded-[2rem] border border-white/10 bg-white/5">
              ...
              <div className="space-y-4">
                <textarea value={msg1} onChange={(e)=>setMsg1(e.target.value)} className="w-full bg-black/50 border border-white/10 p-4 rounded-xl text-xs h-32 text-white" />
                <textarea value={msg2} onChange={(e)=>setMsg2(e.target.value)} className="w-full bg-black/50 border border-white/10 p-4 rounded-xl text-xs h-24 text-white" />
